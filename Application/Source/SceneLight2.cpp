...
void SceneLight2::Init()
{
	...
	meshList[GEO_LIGHTBALL_2] = MeshBuilder::GenerateSphere("lightball2", Color(1, 1, 1), 1.0f);
...
void SceneLight2::Render()
{
	...
	Position lightPosition_cameraspace_2 = viewStack.Top() * light[1].position;
	glUniform3fv(m_parameters[U_LIGHT1_POSITION], 1, &lightPosition_cameraspace_2.x);
